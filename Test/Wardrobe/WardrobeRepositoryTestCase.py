...
def test_create_valid():
    ...
    builder = WardrobeBuilder().with_name('name').with_creator_login('larin').with_description('No desc')
...
def test_get_all_wardrobes_by_login_valid():
    wardrobe_repo = WardrobeRepository(DB_NAME, False)
    first_builder = WardrobeBuilder().with_name('name1').with_creator_login('larin').with_description('No desc1')
    second_builder = WardrobeBuilder().with_name('name2').with_creator_login('larin').with_description('No desc2')
    ...
    result = wardrobe_repo.get_all_wardrobes_by_login('larin')
...
def test_get_all_wardrobes_by_login_invalid():
    ...
    result = wardrobe_repo.get_all_wardrobes_by_login('larin123')
